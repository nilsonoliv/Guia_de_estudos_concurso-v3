/* ============================================================================
 * 1. MÓDULO: STATE & DATA
 * Responsabilidade: Armazenar a "Única Fonte de Verdade" (Single Source of Truth)
 * da aplicação e os dados estáticos do edital.
...
export let estadoApp = {
    ...
    filtroEscada: 'all',
    escada: [
        { id: 1, status: 'ativo', tipo:'ti' }, { id: 2, status: 'bloqueado', tipo:'ti' }, 
        { id: 3, status: 'bloqueado', tipo:'ti' }, { id: 4, status: 'bloqueado', tipo:'ti' }, 
        { id: 5, status: 'bloqueado', tipo:'ti' }, { id: 6, status: 'bloqueado', tipo:'ti' }, 
        { id: 7, status: 'bloqueado', tipo:'ti' }, { id: 8, status: 'bloqueado', tipo:'ti' }, 
        { id: 9, status: 'ativo', tipo:'mt' }, { id: 10, status: 'bloqueado', tipo:'mt' }, 
        { id: 11, status: 'bloqueado', tipo:'mt' }, { id: 12, status: 'bloqueado', tipo:'mt' }, 
        { id: 13, status: 'bloqueado', tipo:'mt' }, { id: 14, status: 'bloqueado', tipo:'mt' }, 
        { id: 15, status: 'bloqueado', tipo:'mt' }, { id: 16, status: 'bloqueado', tipo:'mt' }, 
        { id: 17, status: 'ativo', tipo:'lp' }, { id: 18, status: 'bloqueado', tipo:'lp' }, 
        { id: 19, status: 'bloqueado', tipo:'lp' }, { id: 20, status: 'bloqueado', tipo:'lp' }, 
        { id: 21, status: 'bloqueado', tipo:'lp' }, { id: 22, status: 'bloqueado', tipo: 'lp' }
    ], 
    simulados: [{ data: "Diagnóstico", nota: 35 }],
    swot: { 
        forcas: ["Lógica de programação"], 
        fraquezas: ["Java"], 
        taticas: ["Resolver questões"] 
    },
};
...
export  const dbRoadmap = [
    ...
    { id: 7, titulo: "F7: Estudo Reverso e Redação", meses: "Meses 19-21", color: "blue", objetivo: "Velocidade e Escrita. Correção de lacunas residuais.", semana: [{dia: "Seg", mat: "TI (Questões)"},{dia: "Ter", mat: "Básicas"}, {dia: "Qua", mat: "TI (Questões)"}, {dia: "Qui", mat: "Redação"}, {dia: "Sex", mat: "TI (Questões)"}], metas: ["1 redação/semana sobre tecnologia/bancos.", "50 questões/dia via Estudo Reverso.", "Revisar Deck Anki Master (erros).", "Baixar tempo médio por questão para 2 min."] },
    { id: 8, titulo: "F8: Simulação Total e Véspera", meses: "Meses 22-24", color: "green", objetivo: "Ajuste Fino e Psicológico. Memorização de curto prazo.", semana: [{dia: "Seg", mat: "Revisão Ativa"}, {dia: "Qua", mat: "Revisão Ativa"}, {dia: "Qui", mat: "Revisão Ativa"}, {dia: "Sex", mat: "Simulado Geral"}], metas: ["10 simulados completos com gabarito.", "Revisar Leitura Suja (Prazos/Multas).", "Média de acertos em TI > 85%.", "Simular dia da prova (tempo/alimentação)."] }                
];
