    // --- 1. STATE MANAGEMENT ---
        let estadoApp = {
            ...
            escada: [{ id: 1, status: 'ativo' }, { id: 2, status: 'bloqueado' }, { id: 3, status: 'bloqueado' }, { id: 4, status: 'bloqueado' }, { id: 5, status: 'bloqueado' }, { id: 6, status: 'bloqueado' }, { id: 7, status: 'bloqueado' }, { id: 8, status: 'bloqueado' }, { id: 9, status: 'ativo' }, { id: 10, status: 'bloqueado' }, { id: 11, status: 'bloqueado' }, { id: 12, status: 'bloqueado' }, { id: 13, status: 'bloqueado' }, { id: 14, status: 'bloqueado' }, { id: 15, status: 'bloqueado' }, { id: 16, status: 'bloqueado' }, { id: 17, status: 'ativo' }, { id: 18, status: 'bloqueado' }, { id: 19, status: 'bloqueado' }, { id: 20, status: 'bloqueado' }, { id: 21, status: 'bloqueado' }, { id: 22, status: 'bloqueado' }], 
        ...
        const dbEscada = [
            ...
            { id: 9, tipo: "mt", titulo: "Nível 1: Fundamentos Matemáticos e Legais", desc: "Construir a base para o raciocínio financeiro e jurídico.", topicos: ["Matemática Financeira: Juros simples e compostos, equivalência de capitais.", "Estatística Descritiva: Medidas de tendência central (média, mediana, moda) e dispersão (variância, desvio padrão).", "Legislação Bancária: Sigilo bancário, LGPD e Lavagem de Dinheiro."] },
            { id: 10, tipo: "mt", titulo: "Nível 2: Análise Financeira e Probabilidade", desc: "Aprofundar o entendimento de finanças e incertezas.", topicos: ["Matemática Financeira Avançada: Séries de pagamentos, amortização (SAC, PRICE) e análise de investimentos (VPL, TIR).", "Estatística Inferencial: Probabilidade de Laplace, probabilidade condicional e distribuições estatísticas básicas (normal, binomial, etc.).", "Legislação Específica: Normas do Banco Central, compliance e ética bancária."] },
            { id: 11, tipo: "mt", titulo: "Nível 3: Aplicações Avançadas e Simulações", desc: "Dominar a aplicação prática e a modelagem de cenários complexos.", topicos: ["Modelagem Financeira: Construção de modelos financeiros em Excel e Python.", "Simulações Estatísticas: Simulação de Monte Carlo para análise de risco e tomada de decisão.", "Legislação Avançada: Análise de casos práticos envolvendo legislação bancária e financeira."] },
            { id: 12, tipo: "mt", titulo: "Nível 4: Estratégias de Resolução e Revisão Final", desc: "Preparar para a prova com foco em estratégias de resolução e revisão.", topicos: ["Resolução de Questões: Estratégias para resolver questões de matemática financeira, estatística e legislação de forma rápida e eficiente.", "Revisão de Fórmulas e Conceitos: Revisão intensiva dos principais conceitos, fórmulas e regras gramaticais.", "Simulados Específicos: Realização de simulados focados em matemática financeira, estatística e legislação para identificar pontos fortes e áreas de melhoria."] },
            { id: 13, tipo: "mt", titulo: "Nível 1: Fundamentos Matemáticos e Legais", desc: "Construir a base para o raciocínio financeiro e jurídico.", topicos: ["Matemática Financeira: Juros simples e compostos, equivalência de capitais.", "Estatística Descritiva: Medidas de tendência central (média, mediana, moda) e dispersão (variância, desvio padrão).", "Legislação Bancária: Sigilo bancário, LGPD e Lavagem de Dinheiro."] },
            { id: 14, tipo: "mt", titulo: "Nível 2: Análise Financeira e Probabilidade", desc: "Aprofundar o entendimento de finanças e incertezas.", topicos: ["Matemática Financeira Avançada: Séries de pagamentos, amortização (SAC, PRICE) e análise de investimentos (VPL, TIR).", "Estatística Inferencial: Probabilidade de Laplace, probabilidade condicional e distribuições estatísticas básicas (normal, binomial, etc.).", "Legislação Específica: Normas do Banco Central, compliance e ética bancária."] },
            { id: 15, tipo: "mt", titulo: "Nível 3: Aplicações Avançadas e Simulações", desc: "Dominar a aplicação prática e a modelagem de cenários complexos.", topicos: ["Modelagem Financeira: Construção de modelos financeiros em Excel e Python.", "Simulações Estatísticas: Simulação de Monte Carlo para análise de risco e tomada de decisão.", "Legislação Avançada: Análise de casos práticos envolvendo legislação bancária e financeira."] },
            { id: 16, tipo: "mt", titulo: "Nível 4: Estratégias de Resolução e Revisão Final", desc: "Preparar para a prova com foco em estratégias de resolução e revisão.", topicos: ["Resolução de Questões: Estratégias para resolver questões de matemática financeira, estatística e legislação de forma rápida e eficiente.", "Revisão de Fórmulas e Conceitos: Revisão intensiva dos principais conceitos, fórmulas e regras gramaticais.", "Simulados Específicos: Realização de simulados focados em matemática financeira, estatística e legislação para identificar pontos fortes e áreas de melhoria."] },
