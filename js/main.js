    // --- 1. STATE MANAGEMENT ---
        let estadoApp = {
            ...
            escada: [{ id: 1, status: 'ativo' }, { id: 2, status: 'bloqueado' }, { id: 3, status: 'bloqueado' }, { id: 4, status: 'bloqueado' }, { id: 5, status: 'bloqueado' }, { id: 6, status: 'bloqueado' }, { id: 7, status: 'bloqueado' }, { id: 8, status: 'bloqueado' }, { id: 9, status: 'ativo' }, { id: 10, status: 'bloqueado' }, { id: 11, status: 'bloqueado' }, { id: 12, status: 'bloqueado' }, { id: 13, status: 'bloqueado' }, { id: 14, status: 'bloqueado' }, { id: 15, status: 'bloqueado' }, { id: 16, status: 'bloqueado' }],
